...
<x-layouts.app title="New Goal">
    ...
    <div class="max-w-2xl mx-auto">
        <h1 class="text-2xl font-semibold text-gray-800 mb-6">New Goal</h1>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="type"
                        ...
                        <option value="short_term" {{ old('type') === 'short_term' ? 'selected' : '' }}>Short term</option>
                        <option value="mid_term"   {{ old('type') === 'mid_term'   ? 'selected' : '' }}>Mid term</option>
                        <option value="long_term"  {{ old('type') === 'long_term'  ? 'selected' : '' }}>Long term</option>
                    </select>
                </div>
